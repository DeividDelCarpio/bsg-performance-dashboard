...
def plot_cpu_usage_categorical(
    df, metricas=None, x_col='FechaEvento', granularidad="10 Minutos", top_n=3
):
    """
    Gráfico categórico de uso de CPU, eje X como string, corte por horas.
    """
