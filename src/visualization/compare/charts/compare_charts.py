...
from src.visualization.compare.annotation import compare_annotations
from src.visualization.utils.grouping_utils import group_by_granularity

def plot_cpu_usage_compare(df, metricas=None, x_col='FechaEvento', granularidad="10 Minutos", top_n=3):
    """
    Gráfico de uso de CPU para la sección comparativa, con granularidad y métricas seleccionadas.
    """
